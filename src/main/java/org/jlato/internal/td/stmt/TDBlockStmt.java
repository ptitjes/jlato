...
public class TDBlockStmt extends TreeBase<SBlockStmt, Stmt, BlockStmt> implements BlockStmt {
	...
	public TDBlockStmt(NodeList<Stmt> stmts) {
		super(new SLocation<SBlockStmt>(SBlockStmt.make(TreeBase.<SNodeListState>treeOf(stmts))));
	}
