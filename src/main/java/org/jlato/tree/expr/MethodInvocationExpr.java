...
public class MethodInvocationExpr extends Expr {
	...
	public MethodInvocationExpr withScope(Mutator<Expr> scope) {
		return location.nodeWithChild(SCOPE, scope);
	}
	...
	public MethodInvocationExpr withTypeArgs(Mutator<NodeList<Type>> typeArgs) {
		return location.nodeWithChild(TYPE_ARGUMENTS, typeArgs);
	}
	...
	public MethodInvocationExpr withName(Mutator<Name> name) {
		return location.nodeWithChild(NAME, name);
	}
	...
	public MethodInvocationExpr withArgs(Mutator<NodeList<Expr>> args) {
		return location.nodeWithChild(ARGUMENTS, args);
	}
